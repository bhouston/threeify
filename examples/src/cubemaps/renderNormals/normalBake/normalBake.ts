...
export async function renderGeometryNormalsIntoCubeMap(
  ...
  const cubeFaceNormalScale = {
    [TextureTarget.CubeMapPositiveX]: new Vec3(1, 1, 1),
    [TextureTarget.CubeMapNegativeX]: new Vec3(1, 1, 1),
    [TextureTarget.CubeMapPositiveY]: new Vec3(1, 1, 1),
    [TextureTarget.CubeMapNegativeY]: new Vec3(1, 1, 1),
    [TextureTarget.CubeMapPositiveZ]: new Vec3(1, 1, 1),
    [TextureTarget.CubeMapNegativeZ]: new Vec3(1, 1, 1)
  };
  ...
  for( let index = 0; index < cubeFaceTargets.length; index ++ ) {
    ...
    uniforms.normalScale = cubeFaceNormalScale[target];
