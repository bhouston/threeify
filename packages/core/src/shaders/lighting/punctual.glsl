...
// see https://github.com/KhronosGroup/glTF/tree/master/extensions/2./Khronos/KHR_lights_punctual
...
// https://github.com/KhronosGroup/glTF/blob/master/extensions/2./Khronos/KHR_lights_punctual/README.md#range-property
float getRangeAttenuation(float distanceToLightSource, float maxRange) {
  if (maxRange <= 0.) {
    // negative range means unlimited
    return 1.;
  }
  return max(min(1. - pow(distanceToLightSource / maxRange, 4.), 1.), 0.) /
