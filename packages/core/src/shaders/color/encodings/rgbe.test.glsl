...
void tests(inout TestSuite suite) {
  ...
  testEquivalency(suite, 4, vec3(0.1, 1., 10.));
  testEquivalency(suite, 5, vec3(1.));
  testEquivalency(suite, 6, vec3(10.));
  testEquivalency(suite, 7, vec3(100.));
  testEquivalency(suite, 8, vec3(1000., 100., 10.));
