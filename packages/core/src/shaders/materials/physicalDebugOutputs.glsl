...
#define PHYSICAL_DEBUG_OUTPUT( material ) \
    DEBUG_OUTPUT(1, float(material.alphaMode) / 3.); \
    ...
    DEBUG_OUTPUT(20, material.thickness / 5.); \
    DEBUG_OUTPUT(21, material.attenuationDistance / 5.); \
