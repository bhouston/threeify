...
#pragma import "./debugOutputs.glsl"
#pragma import "../microgeometry/normalPacking.glsl"

#define PHYSICAL_DEBUG_OUTPUT(material)                                        \
  DEBUG_OUTPUT ( 1 , float ( material . alphaMode ) / 3. ) ; DEBUG_OUTPUT ( 2  \
  ...
  normalToColor ( material . clearcoatNormal ) ) ; DEBUG_OUTPUT ( 15 ,         \
  material . sheenColor ) ; DEBUG_OUTPUT ( 16 , material . sheenRoughness ) ;  \
  DEBUG_OUTPUT ( 17 , material . anisotropic ) ; DEBUG_OUTPUT ( 18 , material  \
  . anisotropicDirection ) ; DEBUG_OUTPUT ( 19 , material . transmission ) ;   \
  DEBUG_OUTPUT ( 20 , material . thickness / 5. ) ; DEBUG_OUTPUT ( 21 ,        \
  material . attenuationDistance / 5. ) ; DEBUG_OUTPUT ( 22 , material .       \
  attenuationColor ) ; DEBUG_OUTPUT ( 23 , material . iridescence ) ;          \
  DEBUG_OUTPUT ( 24 , material . iridescenceIor ) ; DEBUG_OUTPUT ( 25 ,        \
