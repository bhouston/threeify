...
vec2 DFGApprox( const in vec3 viewNormal, const in vec3 viewDir, const in float specularRoughness ) {
...
vec3 BRDF_Specular_GGX_IBL( const in vec3 viewNormal, const in vec3 viewDir, const in vec3 specularF0, const in vec3 specularF90, const in float specularRoughness ) {
...
void BRDF_Specular_GGX_Multiscatter_IBL(
    ...
    const in vec3 specularF0,
    const in vec3 specularF90,
