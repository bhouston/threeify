...
void tests(inout TestSuite suite) {
  testDirectionToCubeFaceUV(suite, 0, vec3(1.0, 0.0, 0.0), 0, vec2(0.5, 0.5));
  testDirectionToCubeFaceUV(suite, 10, vec3(-1.0, 0.0, 0.0), 1, vec2(0.5, 0.5));
  testDirectionToCubeFaceUV(suite, 20, vec3(0.0, 1.0, 0.0), 2, vec2(0.5, 0.5));
  testDirectionToCubeFaceUV(suite, 30, vec3(0.0, -1.0, 0.0), 3, vec2(0.5, 0.5));
  testDirectionToCubeFaceUV(suite, 40, vec3(0.0, 0.0, 1.0), 4, vec2(0.5, 0.5));
  testDirectionToCubeFaceUV(suite, 50, vec3(0.0, 0.0, -1.0), 5, vec2(0.5, 0.5));

  testEquivalencySet(suite, 100, vec3(1.0, 0.0, 0.0));
  testEquivalencySet(suite, 110, vec3(-1.0, 0.0, 0.0));
  testEquivalencySet(suite, 120, vec3(0.0, 1.0, 0.0));
  testEquivalencySet(suite, 130, vec3(0.0, -1.0, 0.0));
  testEquivalencySet(suite, 140, vec3(0.0, 0.0, 1.0));
  testEquivalencySet(suite, 150, vec3(0.0, 0.0, -1.0));
