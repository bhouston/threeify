(function () {
  ...
  class Attribute {
    constructor(
      ...
      this.count =
        this.attributeData.arrayBuffer.byteLength / this.vertexStride;
    }
  }
  ...
  (function (BlendFunc) {
    ...
    BlendFunc[(BlendFunc['OneMinusDestAlpha'] = GL.ONE_MINUS_DST_ALPHA)] =
      'OneMinusDestAlpha';
    BlendFunc[(BlendFunc['ConstantColor'] = GL.CONSTANT_COLOR)] =
      'ConstantColor';
    BlendFunc[
      (BlendFunc['OneMinusConstantColor'] = GL.ONE_MINUS_CONSTANT_COLOR)
    ] = 'OneMinusConstantColor';
    BlendFunc[(BlendFunc['ConstantAlpha'] = GL.CONSTANT_ALPHA)] =
      'ConstantAlpha';
    BlendFunc[
  ...
  class VirtualFramebuffer {
    ...
    clear(
      ...
      this.context.clearState =
        (_a =
          clearState !== null && clearState !== void 0
            ? clearState
            : this.clearState) !== null && _a !== void 0
          ? _a
          : this.context.clearState;
      const gl = this.context.gl;
  ...
  function renderBufferGeometry(
    ...
    context.blendState =
      (_a =
        blendState !== null && blendState !== void 0
          ? blendState
          : framebuffer.blendState) !== null && _a !== void 0
        ? _a
        : context.blendState;
    context.depthTestState =
      (_b =
        depthTestState !== null && depthTestState !== void 0
          ? depthTestState
          : framebuffer.depthTestState) !== null && _b !== void 0
        ? _b
        : context.depthTestState;
    context.maskState =
      (_c =
        maskState !== null && maskState !== void 0
          ? maskState
          : framebuffer.maskState) !== null && _c !== void 0
        ? _c
        : context.maskState;
    context.cullingState =
      (_d =
        cullingState !== null && cullingState !== void 0
          ? cullingState
          : framebuffer.cullingState) !== null && _d !== void 0
        ? _d
        : context.cullingState;
  ...
  (function (TextureWrap) {
    TextureWrap[(TextureWrap['MirroredRepeat'] = GL.MIRRORED_REPEAT)] =
      'MirroredRepeat';
    TextureWrap[(TextureWrap['ClampToEdge'] = GL.CLAMP_TO_EDGE)] =
      'ClampToEdge';
  ...
  class TexImage2D {
    ...
    loadImage(image, target = undefined, level = 0) {
      ...
      if (image instanceof Vector2) {
        gl.texImage2D(
          target !== null && target !== void 0 ? target : this.target,
          level,
          this.internalFormat,
          image.width,
          image.height,
  ...
  class Program {
    ...
    validate() {
      ...
      if (psc !== null) {
        if (
          !gl.getProgramParameter(this.glProgram, psc.COMPLETION_STATUS_KHR)
        ) {
          return false;
        }
      }
    ...
    get attributes() {
      if (!__classPrivateFieldGet$1(this, _attributesInitialized)) {
        ...
        for (let i = 0; i < numActiveAttributes; ++i) {
          ...
          __classPrivateFieldGet$1(this, _attributes)[attribute.name] =
            attribute;
        }
  ...
  (_validated = new WeakMap()),
    (_uniformsInitialized = new WeakMap()),
    (_uniforms = new WeakMap()),
    (_attributesInitialized = new WeakMap()),
  ...
  class Extensions {
    constructor(gl) {
      ...
      this.WEBGL_depth_texture = getRequiredExtension(
        gl,
        'WEBGL_depth_texture'
      );
    }
  ...
  (_program = new WeakMap()),
    ...
    (_scissor = new WeakMap()),
    (_viewport = new WeakMap()),
    (_depthTestState = new WeakMap()),
    (_blendState = new WeakMap()),
    (_clearState = new WeakMap()),
    (_maskState = new WeakMap()),
    (_cullingState = new WeakMap());
...
`;
  ...
  async function init() {
    ...
    const context = new RenderingContext(
      document.getElementById('framebuffer')
    );
    let imageIndex = 0;
    const images = [];
    const textures = [];
