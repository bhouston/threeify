...
import { hashFloatArray } from "../model/hash";
...
export class Matrix4 implements IPrimitive<Matrix4> {
  ...
  makeTranslation(t: Vector3): this {
    this.set(1, 0, 0, t.x, 0, 1, 0, t.y, 0, 0, 1, t.z, 0, 0, 0, 1);

    return this;
  }

  makeRotationFromAngleAxis(axis: Vector3, angle: number): this {
