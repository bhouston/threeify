...
export class ShaderMaterial implements IIdentifiable, IVersionable, IDisposable {
	...
	constructor( vertexShaderSourceCode: string, fragmentShaderSourceCode: string ) {
