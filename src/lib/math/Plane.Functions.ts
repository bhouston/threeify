...
export function makePlaneFromTriangle(t: Triangle, result = new Plane()): Plane {
...
export function projectPointOntoPlane(point: Vector3, plane: Plane, result: Vector3 = new Vector3()): Vector3 {
