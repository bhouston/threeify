...
export class TextureImage2D {
    ...
    static FromTexture( context: Context, texture: Texture ) {
        ...
        return new TextureImage2D( context,
            TextureTarget.Texture2D, 0, texture.pixelFormat, texture.image.width, texture.image.height,
            texture.pixelFormat, texture.dataType, texture.wrapS, texture.wrapT, texture.magFilter, texture.minFilter, texture.generateMipmaps, texture.image );
