...
export class DrawTask implements ITask {
    ...
    constructor( program: Program, vertexArrayObject: VertexArrayObject, uniformValues: Array<UniformValue>, primitiveType: PrimitiveType, offset: number, count: number  ) {
