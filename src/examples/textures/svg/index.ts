...
async function init(): Promise<null> {
  const fgTexture = new Texture(await fetchImage("/assets/textures/alphaCompositing/fg75.svg"));
  const bgTexture = new Texture(await fetchImage("/assets/textures/alphaCompositing/bg.svg"));
