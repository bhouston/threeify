...
export function hashFloat1(v: number) {
	floatArray[0] = v;
	return intArray[0];
}

export function hashFloat2(v0: number, v1: number) {
	floatArray[0] = v0;
	floatArray[1] = v1;
...
export function hashFloat3(v0: number, v1: number, v2: number) {
	floatArray[0] = v0;
	floatArray[1] = v1;
	floatArray[2] = v2;
...
export function hashFloat4(v0: number, v1: number, v2: number, v3: number) {
	floatArray[0] = v0;
	floatArray[1] = v1;
	floatArray[2] = v2;
	floatArray[3] = v3;
...
export function hashFloatArray(elements: number[]) {
